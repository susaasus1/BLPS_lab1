...
public class IngredientController {
    ...
    @GetMapping()
    public ResponseEntity<?> getAllIngredients(@RequestParam(value = "page", defaultValue = "0") int page,
    ...
    @GetMapping()
    public ResponseEntity<?> getIngredient(@RequestParam("ingredientId") Long ingredientId) throws IngredientNotFoundException {
